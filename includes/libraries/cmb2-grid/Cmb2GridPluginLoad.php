	...
	class Cmb2GridPlugin extends DesignPatterns\Singleton {
		...
		public function auto_load( $class ) {
			...
			if ( ! isset( $prefix, $base_dir, $sep ) ) {
				// Listing-specific namespace prefix.
		...
		public function wpHead() {
			...
			<style>
				...
				.cmb2GridRow .cmb-repeat-growre-wrap{max-width:100% !important;}
				.cmb2GridRow .cmb-growre-title{margin:0 !important;}
				.cmb2GridRow .cmb-repeat-growre-wrap .cmb-row .cmbhandle, .cmb2GridRow .postbox-container .cmb-row .cmbhandle{right:0 !important}
			</style>
			<?php
